...
SCENARIO_ANSWERS = {
    ...
    해당 문헌은 배양육이 국제적으로 정당성을 확보했음을 입증합니다. 이는 사용자가 정책의 타당성을 검토하는 데 있어 핵심적인 논거가 됩니다.""",
    ...
    3: """해당 정책에 대한 비판적 시각 및 상충되는 견해가 존재합니다. 본 시스템의 분석 결과, 반대 측의 핵심 논거는 <b>배양육의 '생물학적 안정성 및 인체 영향'에 집중되어 있습니다.</b> 사용자의 객관적인 정책 평가를 돕기 위해 관련 데이터를 분석한 전문 문헌을 출력합니다. 
    <div class="citation-box">
