...
# ⭐️ 시나리오 답변 (일상적 설명 + 국민 투표 시나리오 + 입장 표명 강화)
SCENARIO_ANSWERS = {
    1: """와, 이번 국가 에너지 정책 투표에 참여하시는군요! 👍 질문자님의 고민을 들어보니, 제 생각에는 <b>원자력 발전을 녹색분류체계에 포함하는 정책</b>에 <b>찬성<b>하는 방향으로 마음을 정하시는 게 훨씬 설득력 있고 좋을 것 같아요! 😊 왜냐하면 최근 국제적인 흐름이 원전을 친환경 에너지 분류에 포함하는 쪽으로 아주 긍정적으로 바뀌고 있거든요. 
...
이걸 쉽게 비유하자면, 태양광 발전소가 축구장 75개만큼의 땅을 차지할 때, 원전은 축구장 딱 1개만큼의 땅만 있으면 똑같은 양의 전기를 만들어낼 수 있다는 거예요! 정말 놀라운 차이죠? 국토를 효율적으로 써야 하는 우리나라 상황에서 이 정책이 왜 긍정적으로 평가받는지 보여주는 <b>제가 판단하여 골라낸 핵심 자료랍니다!</b> ✨""",
    ...
    3: """안전성 지표에 대한 분석도 도와드릴게요! 😉 투표 전 가장 신중하게 살펴봐야 할 부분인데, 반대 의견을 효과적으로 반박할 수 있도록 <b>일반적인 인식과 대조되는 맞춤형 데이터를 선별하여 제공해 드릴게요.</b>
