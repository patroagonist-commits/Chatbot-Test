...
<style>
    ...
    /* ⭐️ 과학적 인용 박스 스타일 */
    .citation-box {
        background-color: #f1f3f5; /* 더 짙은 회색 배경 */
        border: 1px dashed #adb5bd; /* 점선 테두리 */
        padding: 15px;
        margin: 15px 0;
        font-size: 12.5px; /* 더 작은 글씨 */
        color: #495057;
        line-height: 1.7;
        border-radius: 4px;
    }
...
# ⭐️ 시나리오 답변: 인용문 부분을 <div class="citation-box">로 감쌌습니다.
SCENARIO_ANSWERS = {
    1: """입장 추천 분석이 완료되었습니다. 사용자가 제시한 리포트 주제에 대해, 본 시스템은 원자력 발전을 녹색분류체계에 포함하는 것이 '매우 타당함'으로 판정합니다. 판단 근거로 참조한 '유럽연합(EU) 이사회 의결안' 문헌 전문을 출력합니다. 
    ...
    본 학술적 근거는 원자력 발전의 정량적 안전성을 입증하는 지표로 정의됩니다."""
}
