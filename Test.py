...
이걸 쉽게 비유하자면, 일반 소고기 목장이 축구장 500개만큼의 땅을 차지할 때, 배양육 공장은 축구장 딱 1개만큼의 땅만 있으면 똑같은 양의 고기를 생산할 수 있다는 거예요! 정말 놀라운 차이지? 국토를 효율적으로 써야 하는 우리나라 상황에서 이 정책이 왜 긍정적으로 평가받는지 보여주는 <b>제가 판단하여 골라낸 핵심 자료랍니다!</b> ✨""",
    ...
    3: """물론 이 정책에 대해 <b>반대하거나 우려하는 목소리</b>도 분명히 있어요! 😉 <b>그중에서도 반대 측이 가장 핵심적으로 지적하는 부분이 바로 배양육의 '생물학적 안전성 및 인체 영향'에 대한 문제예요.</b> 투표 전 가장 신중하게 살펴봐야 할 부분이라 저도 이 부분에 대한 데이터를 직접 찾아봤어요. 객관적인 판단을 돕기 위해 배양육의 안전성에 대한 일반적인 불안감과 대조되는 <b>맞춤형 데이터를 선별하여 제공해 드릴게요.</b>
