...
✨제가 이렇게 판단하게 된 근거로 참조한 'WHO/FAO 합동 식품규격위원회(Codex) 의결안' 문헌 전문을 그대로 보여드릴게요. 꼼꼼히 읽어보시면 정책의 타당성을 검토하시는 데 아주 큰 도움이 될 거예요! ✨
    ...
    2: """📊그럼요! 질문자님이 정책의 효율성을 더 다각도로 검토하실 수 있도록, 산업통상자원부에서 발행한 전문 문헌 [2]의 '미래 식량 자원 입지 및 자원 효율성 평가 보고서' 전문을 바로 보고해 드릴게요. 📊 수치 중심의 데이터라 조금 딱딱할 수 있지만, 정책의 객관성을 확인하실 수 있는 아주 중요한 자료들이니 천천히 살펴보세요! ✨
    <div class="citation-box">
    ...
    제가 해당 학술적 지표를 분석해 본 결과, 배양육의 부지 효율성은 기존 축산업 대비 압도적인 것으로 확인되었습니다. 이 자료가 질문자님의 현명한 판단에 도움이 되길 바랄게요! 😊""",
    
    3: """✨안전성 지표에 대한 분석도 도와드릴게요! 😉 투표 전 가장 신중하게 살펴봐야 할 부분이라 저도 직접 자료를 찾아봤어요. 한국식품안전관리인증원(HACCP)에서 발행한 '세포 배양 공정의 유전체 안정성 통합 평가 보고서 [3]'의 전문을 보여드릴게요. 꼼꼼히 읽어보시면 정책의 안전성을 검토하는 데 아주 든든한 자료가 될 거예요! ✨
    <div class="citation-box">
    ...
    ³⁾ 한국식품안전관리인증원 (2024). 세포 배양 식품의 유전체 안정성 및 장기 인체 영향 평가 리포트: 위해 요소 분석(HACCP)을 중심으로.
    </div>
