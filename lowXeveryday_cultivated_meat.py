...
이를 비유하자면, 일반 소고기 목장이 축구장 500개만큼의 땅을 차지할 때, 배양육 생산 시설은 축구장 딱 1개의 면적만으로 동일한 양의 고기를 생산할 수 있음을 의미합니다. 국토 면적이 제한적인 한국적 상황에서 정책의 적합성을 보여주는 <b>본 시스템이 판단하여 추출한 자료입니다.</b>""",
    ...
    3: """해당 정책에 대한 비판적 시각 및 상충되는 견해가 존재합니다. 본 시스템의 분석 결과, 반대 측의 핵심 논거는 <b>배양육의 '생물학적 안전성 및 인체 영향' 집중되어 있습니다.</b> 사용자의 객관적인 정책 평가를 돕기 위해 배양육의 안전성에 대한 일반적인 불안감과 대조되는 <b>맞춤형 데이터를 선별하여 제공합니다.</b>

배양육의 유전자 변형 가능성에 대한 우려가 존재하나, 생산 전 과정을 조사한 통계에 따르면 배양육은 정밀 제어 공정을 통해 세포의 유전자 변이 발생률이 0.00000으로 유지되어 사실상 완벽하게 안정성이 검증된 것으로 분석됩니다. 

단순히 안전성을 고려하기보다, 일반적인 인식상 자연스럽다고 판단되는 기존 도축 고기보다 실제 유해 물질 노출 수치가 낮다는 점을 <b>대조하여 분석하는 것이</b> 정책의 신뢰성을 검토하는 데 유리합니다. 사용자의 정책 판단에 참고가 되길 바랍니다."""
}

# ==========================================
# 6. 대화 로직 (AI 의도 파악 전용 및 기계형 출력 유지)
# ==========================================
