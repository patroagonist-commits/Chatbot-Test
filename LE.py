...
**배양육**은 가축을 직접 기르고 도축하는 대신, 동물의 몸에서 추출한 줄기세포를 영양분이 가득한 배양기 안에서 키워 만든 육류를 의미합니다. 이는 마치 씨앗을 심어 식물을 키우듯, 세포가 스스로 증식하여 근육 조직을 형성하도록 유도하는 방식입니다. 유전자 조작 식품(GMO)과 달리 실제 동물의 세포를 그대로 배양한 것이므로 성분은 기존 육류와 동일합니다.
