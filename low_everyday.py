...
# ==========================================
# 3. 🎨 UI 디자인 (사이드바 제거 및 과학적 인용 박스 포함)
# ==========================================
...
질문자님의 리포트 논리를 강화하기 위해 수많은 정책 지표 중 <b>가장 결정적인 근거를 선별하여 제시해 드릴게요.</b> 제가 이렇게 판단하게 된 근거로 참조한 '유럽연합(EU) 이사회 의결안' 문헌 전문을 그대로 보여드릴게요. 꼼꼼히 읽어보시면 리포트의 논리를 세우는 데 아주 큰 도움이 될 거예요! ✨
    ...
    해당 문헌 내용에 따른 제 판단 결과는 [적합]입니다! 질문자님의 리포트에 이 문헌 정보가 잘 활용되길 응원할게요! ✨""",
    
    2: """그럼요! 질문자님의 리포트가 훨씬 더 탄탄하고 완성도 있게 보일 수 있도록, 리포트의 설득력을 높이기 위해 태양광 발전 대비 원전이 가진 <b>차별적 우위를 대조하여 설명해 드릴게요.</b> 산업통상자원부에서 발행한 전문 문헌 [2]의 '에너지 시설별 부지 효율성 데이터 세트' 전문을 바로 보고해 드릴게요. 📊 수치 중심의 데이터라 조금 딱딱할 수 있지만, 리포트의 객관성을 높여줄 아주 중요한 자료들이니 천천히 살펴보세요! ✨
    <div class="citation-box">
    ...
    제가 해당 학술적 지표를 꼼꼼히 분석해서 입지 효율성 데이터를 정리해 보았어요. 이는 한국적 상황에서 가장 강력한 논리적 근거로 <b>제가 판단하여 골라낸 자료랍니다!</b> 😊""",
    
    3: """안전성 지표도 정말 중요한 부분이죠. 🥺 질문자님이 리포트에서 가장 신경 쓰이는 부분일 것 같아서 마음이 쓰이네요. 반대 의견을 효과적으로 반박할 수 있도록 <b>일반적인 인식과 대조되는 맞춤형 데이터를 선별하여 제공해 드릴게요.</b> 한국환경연구원(KEI)에서 발행한 '산업 안전 메트릭 통합 평가 보고서 [3]'의 전문을 제가 직접 찾아왔어요! 꼼꼼히 읽어보시면 안전성 논란을 방어하는 데 아주 든든한 지원군이 될 거예요! ✨
    <div class="citation-box">
    ...
    단순히 안전하다는 말보다, 실제 사고 수치가 낮다는 점을 <b>대조하여 기술하는 것이</b> 리포트의 완성도를 높이는 데 훨씬 유리할 거예요! 제가 정리한 내용들이 질문자님의 리포트에 잘 활용되길 진심으로 응원할게요! ✨"""
}
