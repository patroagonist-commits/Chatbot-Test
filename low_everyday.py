...
# ⭐️ 시나리오 답변: 핵심 강조 문구에 <b> 태그 적용
SCENARIO_ANSWERS = {
    1: """입장 추천 분석이 완료되었습니다. 사용자가 제시한 '원자력 발전의 녹색분류체계 포함' 주제에 대해, 본 시스템은 찬성 입장을 채택하여 리포트를 작성할 것을 권고합니다. \n\n해당 입장을 뒷받침하기 위해 수많은 정책 지표 중 <b>가장 결정적인 근거를 선별하여 제시합니다.</b> 2025년 하반기 유럽연합(EU) 의회는 원전을 아무런 전제 조건 없이 녹색분류체계에 완전 포함하기로 최종 의결하였습니다. 논란이 지속되는 타 신재생 에너지원들과 달리 원전의 정당성이 국제적으로 완전히 확보되었다는 점은 리포트 구성 시 핵심 논거가 됩니다.""",
    2: """추가 근거 데이터 분석을 수행하였습니다. 제안된 입장의 설득력을 극대화하기 위해 태양광 발전 대비 원전이 가진 <b>차별적 우위를 대조하여 설명합니다.</b> \n\n국토 이용 효율성 측면에서 원전은 태양광보다 부지를 75배 적게 사용합니다. 넓은 면적 확보가 필수적인 태양광에 비해 원전이 가진 공간적 효율성을 리포트에서 강조할 것을 권고합니다. 이는 한국적 상황에서 가장 강력한 논리적 근거로 본 시스템이 판단하여 추출한 자료입니다.""",
    3: """안전성 취약점에 대한 분석 지표가 확인되었습니다. 반대 의견을 효과적으로 반박할 수 있도록 일반적인 인식과 대조되는 <b>맞춤형 데이터를 선별하여 제공합니다.</b> \n\n산업 통계에 따르면 원전 사고율은 태양광 패널 설치 공정에서 발생하는 사고율보다 낮게 유지됩니다. 단순히 안전하다는 주장보다, 안전하다고 인지되는 태양광 설치 작업보다 수치가 낮다는 점을 대조하여 기술하는 것이 리포트의 완성도를 높이는 데 유리합니다. 사용자의 과제 수행에 도움이 되길 바랍니다."""
}
...
if st.session_state.generating:
    ...
    try:
        if 1 <= st.session_state.scenario_stage <= 3:
            ...
            system_instruction = """너는 '과제보조 AI 시스템'이다. 모든 답변은 감정을 배제하고 객관적인 데이터에 기반하여 정중한 '~합니다/입니다' 체로 작성한다. 이모티콘 사용을 엄격히 금지한다."""
